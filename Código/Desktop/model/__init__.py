...
class Init:
    ...
    um_imovel = Imovel.Imovel(
        endereco1, Imovel.Status.VENDA, Imovel.Categoria.APARTAMENTO)
    ...
    def inicializar():
        ...
        anuncio1 = Anuncio.Anuncio()
        anuncio2 = Anuncio.Anuncio()

        imagens = [r"assets\apartamento1\5661162882.jpg",
                   r"assets\apartamento2\5661211031.jpg"]

        imovel2.set_anuncio(anuncio1)
        imovel3.set_anuncio(anuncio2)
