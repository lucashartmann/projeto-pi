...
from textual.containers import Horizontal, Vertical, Grid, HorizontalGroup, VerticalGroup, Container
...
class TelaCadastroImovel(Screen):
    ...
    def compose(self):
        ...
        yield Button("Apagar")
        yield Button("Salvar")
        with Vertical(id="container_cadastro"):
            yield Tabs(Tab("Imovel"), Tab("Info+"))
            yield Static("ref:")
            yield TextArea(read_only=True)
            yield Static("Categoria:")
            yield Select([("Apartamento", "Apartamento"), ("Sala Comercial", "Sala Comercial"), ("Loja", "Loja"), ("Casa", "Casa"), ("Cobertura", "Cobertura"), ("Loft", "Loft"), ("Studio", "Studio"), ("Depósito", "Deposito"), ("Galpão", "Galpao"), ("Pavilhão", "Pavilhao"), ("Prédio Comercial", "Predio Comercial"), ("Ponto Comercial", "Ponto Comercial"), ("Empreendimento", "Empreendimento"), ("Casa em Condominio", "Casa em Condominio"), ("Sobrado", "Sobrado"), ("Sitio", "Sitio"), ("Terreno", "Terreno"), ("Kitnet", "Kitnet"), ("Chacara", "Chacara"), ("Fazenda", "Fazenda"), ("Sobrado", "Sobrado")])
            yield Static("Situação:")
            yield Select([("Novo", "Novo"), ("Usado", "Usado"), ("Construção", "Construcao")])
            yield Static("Estado:")
            yield Select([("Bom", "Bom"), ("Ótimo", "Otimo"), ("Regular", "Regular")])
            yield Static("Ocupacao:")
            yield Select([("Proprietário", "Proprietario"), ("Desocupado", "Desocupado"), ("Inquilino", "Inquilino")])
            yield Static("Status:")
            yield Select([("Venda", "Venda"), ("Aluguel", "Aluguel"), ("Venda e Aluguel"), ("Pendente", "Pendente"), ("Vendido", "Vendido"), ("Alugado", "Alugado")])
