from textual.widgets import Input, Button, Tab, Tabs, Select
...
class TelaUsuariosCadastrados(Screen):

    CSS_PATH = "css/TelaUsuariosCadastrados.tcss"
    ...
    def on_screen_resume(self):
        self.query_one(Tabs).active = self.query_one(
            "#tab_usuario_cadastrados", Tab).id
